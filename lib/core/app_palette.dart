...
class AppPalette {
  ...
  static const lime = AppPalette(
    name: 'Lime',
    note: 'Lime as a surface, not a trim: true black, one green, violet transfers.',
    ...
    darkSurfaceVariant: Color(0xFF1C1C1C),
    darkOutline: Color(0xFF262626),
    darkOnSurface: Color(0xFFF2F4F0),
    darkOnSurfaceVariant: Color(0xFF8E948A),
